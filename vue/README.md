...
The provided skelton project does not include styling libraries (like BootstrapVue, Quasar, Vuetify, etc.). An overview of some of the available libraries vue.js is available here: https://athemes.com/collections/vue-ui-component-libraries/

There is no requirment to make use of a styling library, but it can signficant  decrease the effort  to develop a professional looking website.

Like any major change, it's a REALLY good idea to create a git checkpoint (add, commit, pull, push) before adding additional components.
